...
## 🚨 **Phase 0: 긴급 수정 사항** `1/4 (25%)`

### 📁 즉시 해결 필요
- [v] **0.1** TASKS.md 파일을 루트에 생성
- [ ] **0.2** shared/solar-terms.ts LSP 에러 9개 즉시 수정 (중복 export 문제)  
- [ ] **0.3** 2025년 전체 24절기 데이터 긴급 추가 (한국천문연구원 기준)
- [ ] **0.4** 하드코딩된 2024년을 동적 연도로 변경 (pdf-generator.ts, home.tsx)
